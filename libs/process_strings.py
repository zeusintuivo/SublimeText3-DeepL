...
class ProcessStrings(object):
    ...
    def translate(self, text, target_language, source_language, formato='html', fake=True):
        ...
        if source_language == 'fr':
            ...
            # ' -> ’
            original = original.replace("qu'a", 'qu’a')
            original = original.replace("qu'e", 'qu’e')
            original = original.replace("qu'i", 'qu’i')
            original = original.replace("qu'o", 'qu’o')
            original = original.replace("qu'u", 'qu’u')
            ...
            original = original.replace("n'e", 'n’e')
            original = original.replace("n'i", 'n’i')
            original = original.replace("n'o", 'n’o')
            original = original.replace("n'u", 'n’u')
            original = original.replace("N'A", 'N’A')
            original = original.replace("N'E", 'N’E')
            original = original.replace("N'I", 'N’I')
            original = original.replace("N'O", 'N’O')
            ...
            original = original.replace("d'a", 'd’a')
            original = original.replace("d'e", 'd’e')
            original = original.replace("d'o", 'd’o')
            original = original.replace("d'i", 'd’i')
            original = original.replace("d'u", 'd’u')
            original = original.replace("D'A", 'D’A')
            original = original.replace("D'E", 'D’E')
            original = original.replace("D'O", 'D’O')
            original = original.replace("D'I", 'D’I')
            ...
            original = original.replace("l'a", 'l’a')
            original = original.replace("l'e", 'l’e')
            original = original.replace("l'i", 'l’i')
            original = original.replace("l'o", 'l’o')
            original = original.replace("l'u", 'l’u')
