...
class ProcessStrings(object):
    ...
    def translate(self, text, target_language, source_language, formato='html', fake=True):
        ...
        if source_language == 'fr':
            ...
            original = original.replace("n'e", 'ne e')
            original = original.replace("N'e", 'Ne e')
            original = original.replace("d'a", 'de a')
            original = original.replace("d'o", 'de o')
            original = original.replace("d'i", 'de i')
            original = original.replace("d'u", 'de u')
            original = original.replace("qu'u", 'que u')
            original = original.replace("d'e", 'de e')
            original = original.replace("D'e", 'De e')
            original = original.replace("l'a", 'la a')
            original = original.replace("l'e", 'le e')
            original = original.replace("l'i", 'le i')
            original = original.replace("l'o", 'le o')
            original = original.replace("l'u", 'le u')
            original = original.replace("l'A", 'la A')
            original = original.replace("l'E", 'le E')
            original = original.replace("l'I", 'le I')
            original = original.replace("l'O", 'le O')
